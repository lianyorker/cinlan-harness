...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: archived-sessions, automation, general, git-source-control, hosts, integrations, orchestration, terminal, workspace-layout',
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.settings\' (client-ui-settings-general), so it exists while that entry is mounted',
    occupants: [
