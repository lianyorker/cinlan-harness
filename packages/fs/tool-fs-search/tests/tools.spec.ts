...
class FakeSubprocess extends SubprocessRuntime {
  ...
  override async terminalEnvironment(): Promise<never> { throw new Error('search tools spawn pipes, never terminals') }
  override async spawnTerminal(): Promise<never> { throw new Error('search tools spawn pipes, never terminals') }
  handles: FakeHandle[] = []
