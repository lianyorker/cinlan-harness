...
export const zh = {
  ...
  'shortcut.submitDescription': '在输入框中发送当前消息，遵循运行中的发送方式。',
  'shortcut.accelerated': '加速发送或插话',
  'shortcut.acceleratedDescription': '使用加速发送方式；输入为空时插话发送排队消息。',
  'shortcut.up': '上一条补全',
  'shortcut.down': '下一条补全',
  'shortcut.dismiss': '关闭输入弹层',
  'shortcut.complete': '选中补全',
  'shortcut.popupDescription': '仅在输入补全菜单或弹层可处理时执行。',
  ...
  'placeholder.steerQueue': '{shortcut} 插话发送全部排队消息',
  'input.commands': '指令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  ...
  'settings.enter.description': '智能体运行时发送快捷键和发送按钮的行为；加速发送快捷键使用另一行为',
  'settings.enter.queue': '排队发送',
  'settings.enter.steer': '插话发送',
  'access.auto.label': 'Auto review',
  'access.auto.badge': 'EXP',
  'access.auto.description': '无沙箱运行；每次原生工具调用和 PTC 内层调用前由同一模型进行实验性审查。',
  'access.auto.confirm.title': '确认启用 Auto review（实验）？',
  'access.auto.confirm.description': 'Auto review 不使用沙箱。每次原生工具调用和 PTC 内层调用前，都会由与当前 agent 相同的模型进行审查。此功能仍属实验性，可能误放行或误拒绝，并会消耗额外 token。',
  'access.auto.confirm.acknowledge': '我已了解这些风险，并愿意继续',
  'access.auto.confirm.enable': '启用 Auto review',
...
export const en = {
  'shortcut.submit': 'Send message',
  'shortcut.submitDescription': 'Send from the composer using the active busy-agent behavior.',
  'shortcut.accelerated': 'Accelerated send or steer',
  'shortcut.acceleratedDescription': 'Use accelerated submission, or steer queued messages when the composer is empty.',
  'shortcut.up': 'Previous completion',
  'shortcut.down': 'Next completion',
  'shortcut.dismiss': 'Dismiss input popup',
  'shortcut.complete': 'Select completion',
  'shortcut.popupDescription': 'Acts only when the input completion menu or popup can handle the action.',
  ...
  'placeholder.steerQueue': '{shortcut} steers all queued messages',
  ...
  'settings.enter.description': 'What the send shortcut and Send button do while the agent is running; the accelerated shortcut uses the other behavior',
  'settings.enter.queue': 'Queue',
  'settings.enter.steer': 'Steer',
  'access.auto.label': 'Auto review',
  'access.auto.badge': 'EXP',
  'access.auto.description': 'Run without a sandbox after an experimental same-model review of every native tool call and PTC inner call.',
  'access.auto.confirm.title': 'Enable Auto review (experimental)?',
  'access.auto.confirm.description': 'Auto review runs without a sandbox. Before every native tool call and PTC inner call, the same model as the current agent reviews whether to allow it. This feature is experimental, can falsely allow or deny actions, and uses additional tokens.',
  'access.auto.confirm.acknowledge': 'I understand these risks and want to continue',
  'access.auto.confirm.enable': 'Enable Auto review',
