...
export const zh = {
  cancelInstallTitle: '取消安装？',
  cancelInstallDescription: '正在运行的安装将停止，等待文件恢复完成后才会关闭。',
  managementTab: '管理',
  ...
  loading: '正在读取插件…',
  error: '暂时无法读取插件。',
  unavailable: '当前连接不提供插件管理。桌面端插件由桌面应用管理；其他插件设置仍可在「可配置」标签页中修改。',
  retry: '重试',
  refresh: '刷新',
  empty: '还没有安装任何插件。',
  addPlugin: '添加插件',
  desktopPackages: '请在桌面应用菜单中打开「桌面插件…」，以安装、更新或移除插件。',
  failedOpenPlugins: '无法打开桌面插件窗口：{reason}',
...
export const en = {
  ...
  cancelInstallDescription: 'The running installation will stop. The dialog closes only after its files are restored.',
  ...
  unavailable: 'This connection does not provide plugin management. Desktop plugins are managed by the desktop application; other plugin settings remain available in the Configurable tab.',
  retry: 'Retry',
  refresh: 'Refresh',
  empty: 'No plugins are installed yet.',
  addPlugin: 'Add plugin',
  desktopPackages: 'Open Desktop Plugins… from the desktop application menu to install, update, or remove plugins.',
  failedOpenPlugins: 'Could not open the desktop Plugins window: {reason}',
