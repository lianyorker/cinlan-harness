...
import { Button, Input, IconSearchOutline16, relativeTime } from '@deepseek-ai/dsh-client-ui-primitives'
...
export function ArchivedSessionsSection(props: ArchivedSessionsSectionProps): ReactNode {
  ...
  if (sessions.phase !== 'ready' || workspacePhase !== 'ready') {
  ...
  return (
    <div className={css.section}>
      <Input
        ...
        type="search"
        data-settings-anchor="archived-sessions-search"
        value={query}
