...
The General preference row contributes localized search metadata with the stable `transcript` anchor; the metadata shares the row’s slot registration lifetime.
