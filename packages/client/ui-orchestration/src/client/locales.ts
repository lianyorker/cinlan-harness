...
export const en = {
  nav: 'Orchestration',
  title: 'Orchestration',
  description: 'Coordinate agent workflows and review the capabilities available to each preset.',
  capabilityTitle: 'Agent orchestration',
  capabilityDescription: 'Use the selected composition to coordinate workflows, delegation, and parallel work.',
  capabilityChecking: 'Checking',
  capabilityReady: '{count} ready',
  capabilityNeedsSetup: 'Needs setup',
  capabilityNoPresets: 'No presets',
  capabilityDetails: 'View capability details',
  executionTitle: 'Execution',
  parallelismLabel: 'Parallel tool calls',
  parallelismHelp: 'Host limit for parallel-safe tool calls in each agent step. Applies to the next tool-call group; PTC subcalls use a separate composition limit.',
  save: 'Save',
  saving: 'Saving…',
  ...
  coverageDescription: 'Review workflow, delegation, and engine entries in the evaluated presets.',
  coverageDetailDescription: 'Statuses describe evaluated plugin rows, not provider connectivity.',
  ...
  examplesDescription: 'Choose a pattern supported by the selected composition.',
...
export const zh: OrchestrationDictionary = {
  nav: '编排',
  title: '编排',
  description: '协调 Agent 工作流，并查看各预设可用的能力。',
  capabilityTitle: 'Agent 编排',
  capabilityDescription: '使用当前组成协调工作流、任务委派和并行执行。',
  capabilityChecking: '正在检查',
  capabilityReady: '{count} 个可用',
  capabilityNeedsSetup: '需要配置',
  capabilityNoPresets: '无预设',
  capabilityDetails: '查看能力详情',
  executionTitle: '执行',
  parallelismLabel: '并行工具调用上限',
  parallelismHelp: '主机限制每个 Agent 步骤中可安全并行的工具调用。更改用于下一组工具调用；PTC 子调用使用独立的组成限制。',
  save: '保存',
  saving: '正在保存…',
  reset: '恢复继承值',
  ...
  coverageDescription: '查看已求值预设中的工作流、委派和引擎条目。',
  coverageDetailDescription: '状态描述已求值的插件条目，不代表提供商已连接。',
  workflowTool: '工作流',
  subagentTool: '任务委派',
  coverageActive: '已激活',
  ...
  examplesTitle: '协作方式',
  examplesDescription: '选择当前组成支持的协作方式。',
