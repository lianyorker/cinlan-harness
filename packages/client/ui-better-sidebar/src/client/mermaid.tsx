  ...
  return (
    <div className={css.mermaidWrap}>
      <div className={css.mermaidHeader}>
        <span className={css.mermaidInfo}>{t('mermaidLabel')}</span>
        <button
          type="button"
 ...
 * TextEditor.tsx).
 */
export function MermaidMarkdown({ text, labels: codeLabels }: MermaidMarkdownProps): React.ReactNode {
  ...
  return (
    <div className={css.mermaidMarkdown} ref={containerRef}>
      <MarkdownText text={text} labels={{ code: codeLabels, footnotes: '' }} />
    </div>
  )
}
