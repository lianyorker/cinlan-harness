 ...
 */
export function SideCardSection({ store, service, preferences }: SideCardSectionProps) {
  ...
  return (
    <div className={css.section}>
      ...
      <div className={css.versionBadge}>
        <span className={css.versionBadgeName}>{t('productName')}</span>
