...
export const zh = {
  ...
  terminalShellDefault: '使用默认 Shell',
  terminalShellStart: '启动终端',
  terminalShellLoading: '正在查找已安装的 Shell…',
  terminalShellLoadFailed: '无法列出 Shell。可以重试或使用默认 Shell。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  terminalShellDefault: 'Use default shell',
  terminalShellStart: 'Start terminal',
  terminalShellLoading: 'Finding installed shells…',
  terminalShellLoadFailed: 'Could not list shells. Retry or use the default shell.',
