...
export const zh = {
  shortcutSearchFind: '查找',
  shortcutSearchReplace: '替换',
  shortcutSearchNext: '下一项',
  shortcutSearchPrevious: '上一项',
  shortcutSearchAll: '全部',
  shortcutSearchCase: '区分大小写',
  shortcutSearchRegexp: '正则表达式',
  shortcutSearchWord: '全字匹配',
  shortcutSearchReplaceOne: '替换',
  shortcutSearchReplaceAll: '全部替换',
  shortcutSearchClose: '关闭',
  shortcutSearchCurrent: '当前匹配项',
  shortcutSearchLine: '所在行',
  shortcutSearchReplacedOne: '已替换第 $ 行的匹配项',
  shortcutSearchReplacedAll: '已替换 $ 个匹配项',
  shortcutSave: '保存文件',
  shortcutSaveDescription: '将当前文件编辑器的内容写入主机文件。',
  shortcutFind: '在文件中查找',
  shortcutFindDescription: '打开当前 CodeMirror 文件编辑器的查找面板。',
  shortcutReplace: '在文件中替换',
  shortcutReplaceDescription: '打开当前文件的查找面板并聚焦替换输入框。',
  files: '文件',
  explorer: '资源管理器',
  git: '源代码管理',
  terminal: '终端',
  ...
  collapse: '折叠侧边栏',
  expand: '展开侧边栏',
  fullscreenSidebar: '全屏显示侧边栏',
  restoreSidebar: '还原侧边栏大小',
  collapseBottomPanel: '折叠底部面板',
  expandBottomPanel: '展开底部面板',
  terminalError: '终端连接失败',
  terminalConnectFailed: '终端连接失败',
  terminalDirectoryError: '请选择此会话工作区内已存在的文件夹。在悬浮工作区设置中修改目录后，新建终端；已保存的输入保持不变。',
  terminalProcessExited: '进程已退出，代码 {code}',
  terminalRetry: '重试',
  terminalRename: '重命名终端',
  terminalRenameFailed: '无法重命名终端，请重新连接后重试。',
  terminalRecoverFailed: '无法读取保留的终端。',
  terminalRenameSave: '保存终端标题',
  terminalRenameCancel: '取消终端重命名',
  terminalShellLabel: '此标签页的 Shell',
  terminalShellDefault: '使用设置中的默认 Shell',
  terminalShellStart: '启动终端',
  terminalShellLoading: '正在查找已安装的 Shell…',
  terminalShellLoadFailed: '无法列出 Shell。可以重试或使用设置中的默认 Shell。',
  terminalShellUnavailable: '所选 Shell 不可用。请新建终端标签页并选择其他 Shell。',
  renderErrorPrefix: 'dsh-better-sidebar:',
  chunkMissingComponent: '组件加载失败：缺少 chunk {chunk} 的组件',
  ...
  stageAll: '全部暂存',
  unstageAll: '全部取消暂存',
  commitPlaceholder: '提交信息（Ctrl/Cmd+Enter 检查）',
  commit: '提交',
  commitError: '提交失败',
  branch: '分支',
  ...
  untracked: '未跟踪',
  gitCompare: '比较分支',
  gitCompareFallback: '上游不可用，已使用默认分支 {ref}。',
  gitCompareUnborn: '当前分支尚无提交，无法比较。',
  gitCompareDetached: '当前处于分离 HEAD 状态，无法比较分支。',
  gitCompareNoDefault: '找不到可比较的默认分支。',
  gitCompareNoMergeBase: '当前分支与基准分支没有共同祖先。',
  gitCompareBase: '基准：{ref}（{head}）',
  gitRepository: '仓库：{root}',
  gitBranch: '分支：{branch}',
  gitHead: 'HEAD：{head}',
  gitNoHead: '尚无提交',
  gitDetached: '分离 HEAD',
  gitCommitReview: '检查提交',
  gitCommitConfirm: '确认提交',
  gitCommitMessage: '最终提交信息',
  cancel: '取消',
  diffEmpty: '没有文本差异',
  ...
  settingsNav: '侧边卡片',
  workspaceLayoutNav: '工作区布局',
  workspaceLayoutIntro: '设置工作区侧栏的默认布局和窗口兼容方式。',
  featureSettingsTitle: '功能设置',
  featureSettingsIntro: '设置「{feature}」在工作区中的行为。',
  featureEnabled: '启用此功能',
  featureEnabledDesc: '在工作区显示「{feature}」入口；已有页面和后台工具不受此开关影响。',
  featureUnavailable: '此功能当前不可用。启用提供此功能的插件后即可配置。',
  settingsWriteRejected: '未能保存设置，请重试。',
  ...
  productName: 'DSH-better-sidebar',
  ...
  viewerPdf: 'PDF',
  viewerWord: 'Word 文档',
  viewerExcel: 'Excel 工作簿',
  viewerPowerPoint: 'PowerPoint 演示文稿',
  officeLoading: '正在生成 Office 预览…',
  officeDownload: '下载原文件',
  officeReload: '刷新预览',
  officeRetry: '重试',
  officeMissingFonts: '缺少 {count} 种字体，排版可能不同',
  officeMissingFontsDescription: '主机未安装以下字体，预览中的文字和排版可能与原文件不同。',
  officeUnavailable: 'Office 预览服务不可用。请在运行 Harness 的主机上启用 Office 转换服务。',
  officeInvalid: '无法预览此 Office 文件。文件可能已损坏、受密码保护，或与扩展名不符。',
  officeTooLarge: 'Office 文件或转换后的 PDF 超过预览大小上限。',
  officeTimeout: 'Office 转换超时，请重试。',
  officeBusy: 'Office 预览任务较多，请稍后重试。',
  officeChanged: '文件在读取时已更改，请刷新预览。',
  officeNotFound: '找不到此 Office 文件。',
  officeOutsideWorkspace: '此 Office 文件不在当前会话的工作区内。',
  officeReadFailed: '无法读取 Office 预览，请重试或下载原文件。',
  officeFailed: 'Office 转换未生成可用的预览，请检查文件后重试。',
  officePdfFailed: '浏览器无法显示预览，请重试或下载原文件。',
  ...
  subagentModeContinuable: '可恢复',
  subagentCountStatus: '{running} 运行中 · {history} 历史',
...
export const en: Record<keyof typeof zh, string> = {
  shortcutSearchFind: 'Find',
  shortcutSearchReplace: 'Replace',
  shortcutSearchNext: 'next',
  shortcutSearchPrevious: 'previous',
  shortcutSearchAll: 'all',
  shortcutSearchCase: 'match case',
  shortcutSearchRegexp: 'regexp',
  shortcutSearchWord: 'by word',
  shortcutSearchReplaceOne: 'replace',
  shortcutSearchReplaceAll: 'replace all',
  shortcutSearchClose: 'close',
  shortcutSearchCurrent: 'current match',
  shortcutSearchLine: 'on line',
  shortcutSearchReplacedOne: 'replaced match on line $',
  shortcutSearchReplacedAll: 'replaced $ matches',
  shortcutSave: 'Save file',
  shortcutSaveDescription: 'Write the focused file editor content to the host file.',
  shortcutFind: 'Find in file',
  shortcutFindDescription: 'Open the search panel in the focused CodeMirror file editor.',
  shortcutReplace: 'Replace in file',
  shortcutReplaceDescription: 'Open the current file search panel and focus its replacement input.',
  files: 'Files',
  explorer: 'Explorer',
  git: 'Source Control',
  terminal: 'Terminal',
  ...
  fullscreenSidebar: 'Show sidebar fullscreen',
  restoreSidebar: 'Restore sidebar size',
  ...
  terminalDirectoryError: 'Choose an existing folder inside this session workspace. Change the directory in Floating Workspace settings, then open a new terminal. Your saved input is unchanged.',
  terminalProcessExited: 'Process exited with code {code}',
  terminalRetry: 'Retry',
  terminalRename: 'Rename terminal',
  terminalRenameFailed: 'The terminal could not be renamed. Reconnect and try again.',
  terminalRecoverFailed: 'Retained terminals could not be loaded.',
  terminalRenameSave: 'Save terminal title',
  terminalRenameCancel: 'Cancel terminal rename',
  terminalShellLabel: 'Shell for this tab',
  terminalShellDefault: 'Use Settings default',
  terminalShellStart: 'Start terminal',
  terminalShellLoading: 'Finding installed shells…',
  terminalShellLoadFailed: 'Could not list shells. Retry or use the Settings default.',
  terminalShellUnavailable: 'The selected shell is unavailable. Open a new terminal tab and choose another shell.',
  renderErrorPrefix: 'dsh-better-sidebar:',
  chunkMissingComponent: 'Component missing from chunk {chunk}',
  ...
  commitPlaceholder: 'Commit message (Ctrl/Cmd+Enter to review)',
  commit: 'Commit',
  ...
  unstaged: 'Unstaged',
  untracked: 'Untracked',
  gitCompare: 'Compare branch',
  gitCompareFallback: 'Upstream is unavailable; using the default branch {ref}.',
  gitCompareUnborn: 'This branch has no commits to compare.',
  gitCompareDetached: 'Branch comparison is unavailable with a detached HEAD.',
  gitCompareNoDefault: 'No default branch is available for comparison.',
  gitCompareNoMergeBase: 'The current branch and base branch have no common ancestor.',
  gitCompareBase: 'Base: {ref} ({head})',
  gitRepository: 'Repository: {root}',
  gitBranch: 'Branch: {branch}',
  gitHead: 'HEAD: {head}',
  gitNoHead: 'No commits yet',
  gitDetached: 'Detached HEAD',
  gitCommitReview: 'Review commit',
  gitCommitConfirm: 'Confirm commit',
  gitCommitMessage: 'Final commit message',
  cancel: 'Cancel',
  ...
  workspaceLayoutNav: 'Workspace layout',
  workspaceLayoutIntro: 'Set the default workspace sidebar layout and window compatibility.',
  featureSettingsTitle: 'Feature settings',
  featureSettingsIntro: 'Choose how {feature} behaves in your workspace.',
  featureEnabled: 'Enable feature',
  featureEnabledDesc: 'Show the {feature} workspace entry. Existing tabs and background tools keep running.',
  featureUnavailable: 'This feature is unavailable. Enable its plugin to configure it.',
  settingsWriteRejected: 'Settings could not be saved. Please try again.',
  ...
  viewerImage: 'Image',
  viewerPdf: 'PDF',
  viewerWord: 'Word document',
  viewerExcel: 'Excel workbook',
  viewerPowerPoint: 'PowerPoint presentation',
  officeLoading: 'Preparing Office preview…',
  officeDownload: 'Download original',
  officeReload: 'Refresh preview',
  officeRetry: 'Retry',
  officeMissingFonts: '{count} fonts unavailable; layout may differ',
  officeMissingFontsDescription: 'These fonts are not installed on the Host. Text and layout may differ from the original file.',
  officeUnavailable: 'Office previews are unavailable. Enable the Office conversion service on the computer running Harness.',
  officeInvalid: 'This Office file cannot be previewed. It may be damaged, password protected, or have the wrong extension.',
  officeTooLarge: 'The Office file or converted PDF exceeds the preview size limit.',
  officeTimeout: 'Office conversion timed out. Try again.',
  officeBusy: 'Office preview is busy. Try again shortly.',
  officeChanged: 'The file changed while being read. Refresh the preview.',
  officeNotFound: 'This Office file could not be found.',
  officeOutsideWorkspace: 'This Office file is outside the current conversation workspace.',
  officeReadFailed: 'The Office preview could not be loaded. Try again or download the original file.',
  officeFailed: 'Office conversion did not produce a usable preview. Check the file and try again.',
  officePdfFailed: 'The browser could not display the preview. Try again or download the original file.',
  viewerMarkdown: 'Markdown',
  viewerCode: 'Code',
  ...
  subagentModeContinuable: 'Resumable',
  subagentCountStatus: '{running} running · {history} history',
