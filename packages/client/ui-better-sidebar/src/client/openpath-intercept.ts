 ...
 *
 * `openPath` only receives file paths. Workspace and Session working
 * directories use `ctx.workspaces.revealPath`, which this wrapper does not
 * intercept because the sidebar viewer cannot render a directory.
 *
