 ...
 * an ESM Node artifact plus the two browser client
...
/** Module specifiers the Web shell shares into the frozen module table, including the settings Client export used by lazy chunks. */
