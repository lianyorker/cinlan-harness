...
describe('depsStatus', () => {
  ...
  beforeEach(() => {
    ...
    writeFileSync(join(pkgRoot, 'scripts', 'install.ps1'), '# repair\n')
...
describe('DSH sync contract', () => {
  it('the declared node-pty version stays identical to DSH core (dsh-subprocess-local 1.2.0-beta.15)', () => {
    expect(DSH_NODE_PTY_RANGE).toBe('1.2.0-beta.15')
