...
import { SIDE_BOUNDARY_PROMPT, SIDE_INJECTION_PLUGIN, SIDE_NEW_THREAD_MARKER, sideLabel } from '../src/sidechat-core.ts'
...
describe('sidechat.start', () => {
  ...
  it('creates an EMPTY thread on a blank question (Codex-style immediate create)', async () => {
    ...
    expect(services.rename).toHaveBeenCalledWith(child.session, SIDE_NEW_THREAD_MARKER)
