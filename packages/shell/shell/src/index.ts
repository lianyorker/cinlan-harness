 ...
 *   Once published, subprocess failures settle as `killed` with the error on stderr
 *   after the managed range exits; `done` rejects if that range cannot be observed.
