...
category: '14-idor'
signals:
  ['IDOR', '越权', '枚举', 'UUID预测', 'GraphQL别名', '批量端点', '跨租户', 'CWE-639', '多步链']
mcp_tools: ['http_probe', 'kb_router', 'kb_read_file', 'run_ctf_tool']
keywords:
  ['IDOR', '越权漏洞', '水平越权', 'GraphQL IDOR', 'UUID预测', '批量枚举', 'CWE-639', '访问控制']
difficulty: 'intermediate'
tags: ['idor', 'authorization', 'enumeration', 'graphql', 'multi-tenant', 'web-security', 'ctf']
language: 'zh-CN'
last_updated: '2026-06-25'
related_articles:
  ['ctf-website/14-idor/02-bac-business-logic', 'ctf-website/12-payment/payment-email-bounce-idor']
---
