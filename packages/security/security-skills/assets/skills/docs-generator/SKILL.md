...
| 任务类型           | 使用模板                                                 |
| ------------------ | -------------------------------------------------------- |
| APK/二进制/so 逆向 | `../templates/security-report-templates.md` → 逆向工程报告 |
| 渗透测试/漏洞挖掘  | `../templates/security-report-templates.md` → 渗透测试报告 |
| CTF 解题           | `../templates/security-report-templates.md` → CTF Writeup  |
| JS/Web 签名逆向    | `../templates/security-report-templates.md` → 签名逆向报告 |
| 通用技术文档       | `../templates/report-templates.md` → README / API 文档            |
...
For README, API endpoint, and file organization templates, see [../templates/report-templates.md](../templates/report-templates.md).
...
**安全报告模板**: `../templates/security-report-templates.md`
**通用文档模板**: `../templates/report-templates.md`
