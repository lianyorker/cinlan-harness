...
4. If the signature matches, enumerate _payload shape_, not passwords: try likely authorization claims on the correct cookie name (`admin_session`, `session`, `auth`, etc.).
...
**完整分析**: phishing-asui8-case-study.md（待补充）
