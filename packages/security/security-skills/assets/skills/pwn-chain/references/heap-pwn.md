...
| 2.34        | **移除 **free_hook / **malloc_hook**        | 改走 FILE struct / exit handlers |
...
| House of Roman     | 2.23-2.26   | 12-bit 爆破 + fastbin attack to \_\_malloc_hook            |
...
| House of Husk      | 2.27+       | 改 printf 的 hook table（\_\_printf_function_table）       |
