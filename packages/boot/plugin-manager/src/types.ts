...
export interface PluginManagementHost {
  /** Mandatory application rows that configuration controls cannot disable. */
...
export interface BundleInfo {
  ...
  installed: boolean
  /** Whether the installation labels the bundle as an optional add-on; false when no optional catalog is supplied. */
  optional: boolean
  removable: boolean
...
declare module '@deepseek-ai/cordis' {
  interface Context {
    /** Optional launcher-owned configuration capability; package operations stay with its shell. */
    pluginManagementHost: PluginManagementHost
  }
  interface Events {
    /**
