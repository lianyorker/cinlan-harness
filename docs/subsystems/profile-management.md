...
English | [中文](profile-management.zh.md)

The profile-management API lists running-profile Plugins and bundles, changes persisted composition, and manages bundle installation. [dsh-plugin-manager](../../packages/boot/plugin-manager/README.md) owns operation results, cancellation, and restart requirements; [dsh-app-boot](../../packages/boot/app-boot/README.md) owns the launcher-provided `profileContext` facts.
