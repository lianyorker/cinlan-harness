...
[Execution bindings](../../packages/execution-host/execution-binding/README.md) associate a Workspace and Session with a captured local or SSH deployment. Their leases keep provider selection, directory, permission policy and process incarnation together; Session ownership and persistence remain on the controlling Host. Saved-target inspection readiness does not imply execution readiness. Managed runtime activation retains explicit predecessor deployments, while ordinary target edits invalidate historical configurations.
...
Types: [Agent](core.md) · [AgentSetupCommit](../../packages/core/agent/README.md) · [ExecutionBinding](../../packages/execution-host/execution-binding/README.md) · [ExecutionLease](../../packages/execution-host/execution-binding/README.md) · [SessionId](core.md)
...
Types: [ExecutionAuthorization](../../packages/execution-host/execution-host-targets/README.md) · [SshConfig](../../packages/ssh/ssh/README.md) · [SshExecutionConfiguration](../../packages/execution-host/execution-host-targets/README.md) · [SshExecutionSnapshot](../../packages/execution-host/execution-host-targets/README.md)
