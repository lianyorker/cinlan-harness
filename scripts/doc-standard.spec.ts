...
const PACKAGE_LIBRARIES: Readonly<Record<string, string>> = {
  'packages/security/finding-export': 'Deterministic report byte library with no plugin registration.',
  ...
  'packages/experimental/browser-use-runtime': 'Shared browser MCP runtime helpers; plain module exports with no plugin entry.',
