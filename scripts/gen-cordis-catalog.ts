...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  automationController: 'typert.md',
  automationRuntime: 'automation.md',
  betterSidebar: 'web-client.md',
  browser: 'browser.md',
  browserController: 'typert.md',
  computerUse: 'device-control.md',
  coordination: 'coordination.md',
  deviceCapabilitiesController: 'typert.md',
  executionBindings: 'execution-host.md',
  executionRuntimes: 'execution-host.md',
  executionHost: 'execution-host.md',
  executionHostController: 'typert.md',
  executionHostTargets: 'execution-host.md',
  findings: 'security-research.md',
  git: 'git.md',
  integrationPreflightController: 'typert.md',
  mcpController: 'typert.md',
  mcpManagement: 'mcp.md',
  mcpRegistry: 'mcp.md',
  mobileDevice: 'device-control.md',
  mobileRuntime: 'device-control.md',
  remoteAccess: 'web-server.md',
  remoteAccessHost: 'web-server.md',
  pairingController: 'typert.md',
  securityResearchController: 'typert.md',
  securitySkillResources: 'security-research.md',
  browserRuntime: 'browser.md',
  sidebarGit: 'git.md',
  sidebarGitController: 'typert.md',
  sidebarTerminalController: 'typert.md',
  sidebarTerminals: 'terminal.md',
  terminalController: 'typert.md',
  usageController: 'typert.md',
  usageQuery: 'session-query.md',
  voice: 'voice.md',
  voiceController: 'typert.md',
  vulnKb: 'security-research.md',
  workspaceIsolation: 'workspace.md',
  workspaceIsolationController: 'typert.md',
  worktreeTask: 'workspace.md',
  worktreeTaskController: 'typert.md',
  agentLoop: 'core.md',
  ...
  workItems: 'work-items.md',
  workItemsController: 'work-items.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  automationClient: 'client-side Automation observable source and generated Remote commands — packages/api/automation-controller/README.md owns the Client API',
  sidebarTerminalClient: 'client-side factory for one supervised terminal transport scope, not a Host service — packages/api/sidebar-terminal-controller/README.md owns the API',
  dshProfileName: 'not a service: optional boot-provided profile-name string — packages/boot/app-boot/README.md owns this launcher context value',
  executionPlatform: 'not a service: per-execution platform metadata supplied by agent preset composition — docs/subsystems/execution-host.md documents the execution scope and packages/preset/agent-presets/README.md owns the value',
  keyboard: 'client-side interface-typed keyboard matcher and scoped registrations — packages/client/keyboard/README.md owns the API',
  settingsMetadata: 'client-side settings navigation and localized value-free search registry — packages/client/ui-settings/README.md owns the API',
  floatingWorkspaceContext: 'not a service: client callback resolving the current floating terminal context — packages/terminal/sidebar-terminals/README.md owns this binding',
  floatingTerminalConsumer: 'not a service: true-valued marker identifying a floating terminal consumer — packages/terminal/sidebar-terminals/README.md owns this binding',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  RuntimeInspection: '../../packages/execution-host/execution-runtime/README.md',
  RuntimeLocation: '../../packages/execution-host/execution-runtime/README.md',
  RuntimeStartRequest: '../../packages/execution-host/execution-runtime/README.md',
  RuntimeTaskValue: '../../packages/execution-host/execution-runtime/README.md',
  RuntimeTaskRequest: '../../packages/execution-host/execution-runtime/README.md',
  RuntimeTasksValue: '../../packages/execution-host/execution-runtime/README.md',
  ExecutionBinding: '../../packages/execution-host/execution-binding/README.md',
  ExecutionAuthorization: '../../packages/execution-host/execution-host-targets/README.md',
  ExecutionLease: '../../packages/execution-host/execution-binding/README.md',
  SshExecutionConfiguration: '../../packages/execution-host/execution-host-targets/README.md',
  SshExecutionSnapshot: '../../packages/execution-host/execution-host-targets/README.md',
  SshConfig: '../../packages/ssh/ssh/README.md',
  AgentSetupCommit: '../../packages/core/agent/README.md',
  MobileRuntimeStatus: '../../packages/mobile-device/mobile-device-runtime/README.md',
  MobileResourceRequest: '../../packages/mobile-device/mobile-device-runtime/README.md',
  MobileResourceTask: '../../packages/mobile-device/mobile-device-runtime/README.md',
  MobileResourceTaskId: '../../packages/mobile-device/mobile-device-runtime/README.md',
  MobileMirrorStatus: '../../packages/mobile-device/mobile-device-runtime/README.md',
  MobileMirrorId: '../../packages/mobile-device/mobile-device-runtime/README.md',
  MobileExecutableLease: '../../packages/mobile-device/mobile-device-runtime/README.md',
  RemoteAccessStatus: '../../packages/remote-access/remote-access/README.md',
  PairingGrant: '../../packages/remote-access/remote-access/README.md',
  PairingInvitation: '../../packages/remote-access/remote-access/README.md',
  PairedDeviceId: '../../packages/remote-access/remote-access/README.md',
  HostConnectionAccess: '../../packages/client/connection/README.md',
  TypertGatewayAccessPolicy: 'typert.md',
  SidebarUiTerminalSnapshot: '../../packages/terminal/sidebar-terminals/README.md#ownership-and-lifetime',
  SidebarTerminalRenameUiRequest: '../../packages/terminal/sidebar-terminals/README.md#ownership-and-lifetime',
  ...
  AssessmentDecision: 'security-research.md',
  AssessmentGrant: 'security-research.md',
  AssessmentGrantStatus: 'security-research.md',
  AssessmentOperation: 'security-research.md',
  AssessmentSessionOperation: 'security-research.md',
  AutomationCancelRequest: 'typert.md',
  AutomationCatalog: 'typert.md',
  AutomationDefinition: 'automation.md',
  AutomationDelete: 'automation.md',
  AutomationDraft: 'automation.md',
  AutomationFollowFrame: 'typert.md',
  AutomationId: 'automation.md',
  AutomationPreviewRequest: 'typert.md',
  AutomationRun: 'automation.md',
  AutomationRunId: 'automation.md',
  AutomationRunPage: 'automation.md',
  AutomationRunRequest: 'automation.md',
  AutomationRunsRequest: 'typert.md',
  AutomationSchedule: 'automation.md',
  AutomationSnapshot: 'automation.md',
  AutomationUpdate: 'automation.md',
  BindSessionRequest: 'workspace.md',
  BindSessionResult: 'workspace.md',
  BrowserDownloadRequest: 'typert.md',
  BrowserDownloadValue: 'typert.md',
  BrowserDownloadsValue: 'typert.md',
  BrowserFileUploadRequest: 'typert.md',
  BrowserFileUploadValue: 'typert.md',
  BrowserHistoryValue: 'typert.md',
  BrowserImportCookiesRequest: 'typert.md',
  BrowserImportCookiesValue: 'typert.md',
  BrowserNetworkValue: 'typert.md',
  BrowserObservationValue: 'typert.md',
  BrowserOpenValue: 'typert.md',
  BrowserPageRequest: 'typert.md',
  BrowserPagesValue: 'typert.md',
  BrowserElementSelectionValue: 'typert.md',
  BrowserElementCaptureCommand: 'typert.md',
  BrowserElementCaptureValue: 'typert.md',
  BrowserProfileValue: 'typert.md',
  ComputerActionResult: 'device-control.md',
  ComputerApp: 'device-control.md',
  ComputerCapabilities: 'device-control.md',
  ComputerToolReadiness: 'device-control.md',
  ComputerReadiness: 'device-control.md',
  BrowserRuntimeStatus: 'browser.md',
  BrowserRuntimeTask: 'browser.md',
  BrowserRuntimeTaskId: 'browser.md',
  BrowserRuntimeCancelRequest: 'browser.md',
  ProviderSelection: 'browser.md',
  ComputerClickRequest: 'device-control.md',
  ComputerDragRequest: 'device-control.md',
  ComputerHotkeyRequest: 'device-control.md',
  ComputerListWindowsRequest: 'device-control.md',
  ComputerObservation: 'device-control.md',
  ComputerObserveRequest: 'device-control.md',
  ComputerPasteTextRequest: 'device-control.md',
  ComputerPressKeyRequest: 'device-control.md',
  ComputerScrollRequest: 'device-control.md',
  ComputerSecondaryActionRequest: 'device-control.md',
  ComputerSetValueRequest: 'device-control.md',
  ComputerTypeTextRequest: 'device-control.md',
  ComputerUseProvider: 'device-control.md',
  ComputerWindow: 'device-control.md',
  CreateTaskRequest: 'workspace.md',
  CveId: 'security-research.md',
  DefineToolOptions: 'tools.md',
  DeleteTaskRequest: 'workspace.md',
  DeleteTaskResult: 'workspace.md',
  DeviceCapabilityRequest: 'typert.md',
  DeviceCapabilitySnapshot: 'typert.md',
  EnsureWorkspaceIsolationRequest: 'workspace.md',
  FindingOperationOptions: 'security-research.md',
  FindingProvenance: 'security-research.md',
  FindingQueryPage: 'security-research.md',
  FindingQueryRequest: 'security-research.md',
  FindingRecordRequest: 'security-research.md',
  FindingRef: 'security-research.md',
  FindingSnapshot: 'security-research.md',
  FindingTransitionRequest: 'security-research.md',
  HibernateTaskRequest: 'workspace.md',
  IntegrationPreflightRequest: 'typert.md',
  IntegrationPreflightSnapshot: 'typert.md',
  McpConnectionSnapshot: 'mcp.md',
  McpManagementSnapshot: 'mcp.md',
  McpRemoveRequest: 'mcp.md',
  McpSaveRequest: 'mcp.md',
  McpSaveResult: 'mcp.md',
  McpServerRequest: 'mcp.md',
  McpSetEnabledRequest: 'mcp.md',
  MobileButtonRequest: 'device-control.md',
  MobileDevice: 'device-control.md',
  MobileDeviceListSnapshot: 'typert.md',
  MobileDeviceProvider: 'device-control.md',
  MobileDeviceSettings: 'device-control.md',
  MobileMutationResult: 'device-control.md',
  MobileObservation: 'device-control.md',
  MobileObserveRequest: 'device-control.md',
  MobileSdkSnapshot: 'typert.md',
  MobileTouchRequest: 'device-control.md',
  MobileTypeRequest: 'device-control.md',
  ParameterSchemaSpec: 'tools.md',
  ...
  SidebarTerminalCapability: 'terminal.md',
  SidebarTerminalCloseAgentRequest: 'terminal.md',
  SidebarTerminalCloseUiRequest: 'terminal.md',
  SidebarTerminalFrame: 'terminal.md',
  SidebarTerminalInputRequest: 'terminal.md',
  SidebarTerminalOpenRequest: 'terminal.md',
  SidebarTerminalProcessId: 'terminal.md',
  SidebarTerminalReleaseRequest: 'terminal.md',
  SidebarTerminalResizeRequest: 'terminal.md',
  SidebarTerminalSessionId: 'terminal.md',
  SidebarTerminalUiTarget: 'terminal.md',
  TerminalKillRequest: 'typert.md',
  TerminalKillValue: 'typert.md',
  TerminalListRequest: 'typert.md',
  TerminalListValue: 'typert.md',
  TerminalReadValue: 'typert.md',
  TerminalSendValue: 'typert.md',
  TerminalSignalRequest: 'typert.md',
  TerminalSignalValue: 'typert.md',
  TerminalSpawnValue: 'typert.md',
  UsageQueryRequest: 'session-query.md',
  UsageQueryResult: 'session-query.md',
  ValueSchemaSpec: 'tools.md',
  VoiceEngine: 'voice.md',
  VoiceEngineStatus: 'voice.md',
  VoiceModelDefinition: 'voice.md',
  VoiceModelId: 'voice.md',
  VoiceModelRequest: 'typert.md',
  VoiceModelsDownloadValue: 'voice.md',
  VoiceModelTask: 'voice.md',
  VoiceModelTaskId: 'voice.md',
  VoiceCancelRequest: 'voice.md',
  VoiceModelsCancelValue: 'voice.md',
  VoiceModelsListValue: 'voice.md',
  VoiceModelsRemoveValue: 'typert.md',
  VoiceOperations: 'voice.md',
  VoiceTranscribeRequest: 'voice.md',
  VoiceTranscribeResult: 'voice.md',
  VulnEntry: 'security-research.md',
  VulnKbProvider: 'security-research.md',
  VulnQueryRequest: 'security-research.md',
  VulnQueryResult: 'security-research.md',
  WorkspaceIsolationComparison: 'workspace.md',
  WorkspaceIsolationComparisonValue: 'typert.md',
  WorkspaceIsolationInspection: 'workspace.md',
  WorkspaceIsolationInspectionValue: 'typert.md',
  WorkspaceIsolationIntegrationResult: 'workspace.md',
  WorkspaceIsolationIntegrationValue: 'typert.md',
  WorkspaceIsolationLease: 'workspace.md',
  WorkspaceIsolationLeaseId: 'workspace.md',
  WorkspaceIsolationLeaseRequest: 'typert.md',
  WorkspaceIsolationLeaseValue: 'typert.md',
  WorkspaceIsolationListValue: 'typert.md',
  WorkspaceIsolationPatch: 'workspace.md',
  WorkspaceIsolationPatchValue: 'typert.md',
  WorkspaceIsolationPruneValue: 'typert.md',
  WorkspaceIsolationReservation: 'workspace.md',
  WorkspaceIsolationTeardownResult: 'workspace.md',
  WorkspaceIsolationTeardownValue: 'typert.md',
  WorktreeTask: 'workspace.md',
  WorktreeTaskSettings: 'workspace.md',
  UpdateWorktreeTaskSettingsRequest: 'workspace.md',
  WorktreeTaskReview: 'workspace.md',
  WorktreeTaskBindSessionRequest: 'typert.md',
  WorktreeTaskBindSessionValue: 'typert.md',
  WorktreeTaskCreateRequest: 'typert.md',
  WorktreeTaskCreateValue: 'typert.md',
  WorktreeTaskDeleteValue: 'typert.md',
  WorktreeTaskId: 'workspace.md',
  WorktreeTaskListValue: 'typert.md',
  WorktreeTaskRequest: 'typert.md',
  WorktreeTaskValue: 'typert.md',
  WorkItemsListRequest: 'work-items.md',
  WorkItemsListValue: 'work-items.md',
  WorkItemView: 'work-items.md',
  WorkItemsGetRequest: 'work-items.md',
  WorkItemsAssociationRequest: 'work-items.md',
  WorkItemsAssociationValue: 'work-items.md',
  WorkItemsPrepareWriteRequest: 'work-items.md',
  WorkItemsWriteValue: 'work-items.md',
  WorkItemsWriteRequest: 'work-items.md',
  WorkItemsWriteHistoryRequest: 'work-items.md',
  WorkItemsWriteHistoryValue: 'work-items.md',
  WorkItemsProvider: 'work-items.md',
  WorkItemMutation: 'work-items.md',
  WorkItemWriteOperation: 'work-items.md',
  WorkItemWriteId: 'work-items.md',
  WorkItemSource: 'work-items.md',
  WorkItemListRequest: 'work-items.md',
  WorkItemPage: 'work-items.md',
  WorkItem: 'work-items.md',
  WorkItemGetRequest: 'work-items.md',
  Agent: 'core.md',
  ...
  SessionMessageProjectionContext: 'session.md',
  ...
  PermissionSelection: 'permission-presets.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  ArtifactRef: 'packages/artifact/artifact/README.md owns the non-catalog immutable ArtifactRef metadata, publication/description, and reference authorization API.',
  BrowserClickRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserClickResult: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserCloseRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserCookieImportRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserDownload: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserDownloadId: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserDownloadedFile: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserElementCaptureRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserElementScreenshot: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserElementSelection: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserElementSelectionRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserHistoryEntry: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserNavigateRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserNavigateResult: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserNavigationTarget: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserNetworkEntry: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserObservation: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserOpenRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserOpenResult: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserPage: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserPageId: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserProvider: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserScreenshot: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserScreenshotRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserSnapshotRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  BrowserUploadRequest: 'packages/browser/browser/README.md owns the non-catalog Provider selection, page/observation identities, native navigation, capture, and transfer API.',
  CoordinationApprovalDecision: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  CoordinationApprovalRequest: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  CoordinationApprovalRequestListener: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  CoordinationEventListener: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  CoordinationRun: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  CreateTargetRequest: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  ExecutionHostInfo: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  FileViewerDescriptor: 'packages/client/ui-better-sidebar/docs/external-plugin-guide.md owns the non-catalog Sidebar tab/viewer registration, Session scope, open seeds, and snapshot API.',
  GitBranchesResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitCheckoutRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitCommitPreview: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitCommitRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitCommitResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitCompareResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitDiff: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitDiffRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitDiffResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitDiscardRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitLogEntry: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitLogRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitMutationResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitPathMutationRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitPrepareCommitRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitRepository: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitResolveRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitRevisionMutationRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitRevisionRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitSessionRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitShowRequest: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitShowResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitStatus: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  GitStatusResult: 'packages/git/git/README.md and packages/git/sidebar-git/README.md own the non-catalog Git repository/Provider requests and Session-bound review/mutation API; identically named request/result types retain their declaring package fields.',
  InspectDirectoryRequest: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  InspectionValue: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  ListTargetsValue: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  OpenTabSeed: 'packages/client/ui-better-sidebar/docs/external-plugin-guide.md owns the non-catalog Sidebar tab/viewer registration, Session scope, open seeds, and snapshot API.',
  RunId: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  RunSnapshot: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  SessionScope: 'packages/client/ui-better-sidebar/docs/external-plugin-guide.md owns the non-catalog Sidebar tab/viewer registration, Session scope, open seeds, and snapshot API.',
  SidebarSnapshot: 'packages/client/ui-better-sidebar/docs/external-plugin-guide.md owns the non-catalog Sidebar tab/viewer registration, Session scope, open seeds, and snapshot API.',
  StartRunRequest: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  TabDescriptor: 'packages/client/ui-better-sidebar/docs/external-plugin-guide.md owns the non-catalog Sidebar tab/viewer registration, Session scope, open seeds, and snapshot API.',
  TargetRequest: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  TargetRevisionRequest: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  TargetValue: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
  TaskExecutor: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  TaskId: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  TaskMessage: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  TaskMessageListener: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  TaskSnapshot: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  TaskSpec: 'packages/coordination/coordination/README.md owns the non-catalog Run/Task dependency, messaging, approval, cancellation, and executor API.',
  UpdateTargetRequest: 'packages/execution-host/execution-host/README.md and packages/execution-host/execution-host-targets/README.md own the non-catalog Host identity and saved SSH target/revision/directory API; worker protocol details remain in packages/execution-host/execution-host-worker/README.md.',
