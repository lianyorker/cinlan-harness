...
async function boot(options: { holdPaint?: boolean; failPreparation?: boolean; holdHost?: boolean } = {}) {
  vi.resetModules()
  ...
  vi.doMock('../src/project-manager.ts', () => ({ DesktopProjectManager: vi.fn(function () {}) }))
